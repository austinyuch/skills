...
1. Read the [Spec Master family page](../skills/spec-master/index.html) for routing and authority surfaces.
2. Read the [Spec-Driven Development brief](../skills/spec-master/index.html) for the lifecycle and artifacts.
...
1. 閱讀 [Spec Master 家族頁](../skills/spec-master/index.html)，了解路由與權威面。
2. 閱讀 [規格驅動開發說帖](../skills/spec-master/index.html)，了解生命週期與工件。
