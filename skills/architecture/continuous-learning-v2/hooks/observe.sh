...
#     "PreToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": "~/.config/opencode/skills/continuous-learning-v2/hooks/observe.sh pre" }]
#     }],
#     "PostToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": "~/.config/opencode/skills/continuous-learning-v2/hooks/observe.sh post" }]
#     }]
#   }
# }
...
CONFIG_DIR="${HOME}/.config/opecode/homunculus"
