...
**AI / Security / Privacy / Log Compliance Inventory**：若本 spec 涉及 AI/security/privacy/PII/log/regulatory-compliance scope，必須組合 `iso-ai-security-auditor`，把其 inventory / evidence refs 作為 requirements、design、review inputs。它是 internal-audit readiness / gap-table lens，不是法律意見、ISO/CNS certification verdict、或 `review.md` readiness verdict。
