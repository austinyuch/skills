...
- 若任務涉及 `TESTS.md`、workspace `.agents/specs/TESTS.md`、`SPECS.md`、或 `RTM.md` 的跨 artifact 更新，必須依 `shared-governance` skill 的 `references/cross-artifact-regeneration-order.md` 的順序重新生成，而不是在剛寫出的 derived artifact 上做修補式同步。
