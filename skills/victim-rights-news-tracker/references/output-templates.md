...
| # | 日期 | 標題 | 來源 | 重點摘要 | 標籤 |
|---|------|------|------|----------|------|
| 1 | YYYY-MM-DD | [標題](https://example.com) | 媒體 | 重點 | #案件名稱 |
| 2 | YYYY-MM-DD | [標題](https://example.com) | 媒體 | 重點 | #案件名稱 |
...
|----------|----------|---------|----------|
| 描述... | [報導標題](https://example.com) | [URL](https://example.com) | 合理使用 |
...
1. [報導標題 1](https://example.com) - 媒體名稱
2. [報導標題 2](https://example.com) - 媒體名稱
3. [...]
...
|------|------|------|----------|--------------|
| 發生 | YYYY-MM-DD | 案件發生 | [報導](https://example.com) | - |
| 調查 | YYYY-MM-DD | 警方調查 | [報導](https://example.com) | 家屬首次發聲 |
| 起訴 | YYYY-MM-DD | 檢察官起訴 | [報導](https://example.com) | 家屬表達訴求 |
| 一審 | YYYY-MM-DD | 一審判決 | [報導](https://example.com) | 家屬抗議輕判 |
| 上訴 | YYYY-MM-DD | 二審開庭 | [報導](https://example.com) | 持續參與訴訟 |
...
| # | 日期 | 標題 | 來源 | 摘要 | 重要程度 |
|---|------|------|------|------|----------|
| 1 | YYYY-MM-DD | [標題](https://example.com) | 媒體 | 摘要... | ⭐⭐⭐⭐⭐ |
| 2 | YYYY-MM-DD | [標題](https://example.com) | 媒體 | 摘要... | ⭐⭐⭐⭐ |
| ... | ... | ... | ... | ... | ... |
...
- **與受害者關係**：XXX
- **公開發言**：
  - YYYY-MM-DD：「...」[來源](https://example.com)
  - YYYY-MM-DD：「...」[來源](https://example.com)
...
| 日期 | 活動類型 | 內容 | 報導連結 |
|------|----------|------|----------|
| YYYY-MM-DD | 記者會 | 說明... | [報導](https://example.com) |
| YYYY-MM-DD | 陳情 | 說明... | [報導](https://example.com) |
...
- 所有來源都應提供完整 URL
- 使用 Markdown 連結格式：`[顯示文字](https://example.com)`
- 圖片 URL 應測試是否可存取
...
```markdown
### [中文標題]
- **來源**：[中文媒體](https://example.com)
- **摘要**：中文摘要...
- **English Summary**: Brief English summary...

### [English Title]
- **Source**: [English Media](https://example.com)
...
| 語言 | 標題 | 來源 | 摘要 |
|------|------|------|------|
| 中文 | [標題](https://example.com) | 媒體A | 摘要... |
| EN | [Title](https://example.com) | Media B | Summary... |
```
...
| 日期 | 場合 | 內容摘要 | 立場 | 來源 |
|------|------|----------|------|------|
| YYYY-MM-DD | 記者會 | 呼籲加速修法進度，批評司法忽視家屬權益 | ⭐⭐⭐⭐⭐ | [聯合報](https://example.com) |
| YYYY-MM-DD | 聯合聲明 | 與其他NPO共同聲明支持被害人訴訟參與入法 | ⭐⭐⭐⭐⭐ | [中央社](https://example.com) |
...
| 日期 | 場合 | 內容摘要 | 立場 | 來源 |
|------|------|----------|------|------|
| YYYY-MM-DD | 黨團記者會 | 宣布優先推動《刑事被害人保護法》修法 | ⭐⭐⭐⭐⭐ | [自由時報](https://example.com) |
...
| 日期 | 場合 | 內容摘要 | 立場 | 來源 |
|------|------|----------|------|------|
| YYYY-MM-DD | 記者詢問 | 「尊重立法院審查，將評估法案影響」 | ⭐⭐⭐ | [中央社](https://example.com) |
...
| 日期 | 場合 | 內容摘要 | 立場 | 來源 |
|------|------|----------|------|------|
| YYYY-MM-DD | 立法院質詢 | 質詢法務部長被害人訴訟參與制度進度，要求明確時間表 | ⭐⭐⭐⭐⭐ | [自由時報](https://example.com) |
| YYYY-MM-DD | 記者會 | 批評司法院態度消極，呼籲正視家屬需求 | ⭐⭐⭐⭐⭐ | [聯合報](https://example.com) |
...
| 日期 | 場合 | 內容摘要 | 立場 | 來源 |
|------|------|----------|------|------|
| YYYY-MM-DD | 學術研討會 | 「被害人訴訟參與有助於事實釐清，應予立法保障」 | ⭐⭐⭐⭐ | [法律白話文](https://example.com) |
...
**報告製作**：Victim Rights News Tracker Skill  
**人物圖像建立方法**：參考 [references/tag-registry.md](references/tag-registry.md) 的角色立場追蹤章節
