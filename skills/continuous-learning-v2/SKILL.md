...
Add to your `~/.config/opencode/settings.json`.
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "~/.config/opencode/skills/continuous-learning-v2/hooks/observe.sh pre"
          }
        ]
      }
    ],
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "~/.config/opencode/skills/continuous-learning-v2/hooks/observe.sh post"
          }
        ]
      }
    ]
...
```bash
mkdir -p ~/.config/opencode/homunculus/{instincts/{personal,inherited},evolved/{agents,skills,commands}}
touch ~/.config/opencode/homunculus/observations.jsonl
```
...
```json
{
  ...
  "observation": {
    "enabled": true,
    "store_path": "~/.config/opencode/homunculus/observations.jsonl",
    "max_file_size_mb": 10,
    "archive_after_days": 7
  },
  "instincts": {
    "personal_path": "~/.config/opencode/homunculus/instincts/personal/",
    "inherited_path": "~/.config/opencode/homunculus/instincts/inherited/",
    "min_confidence": 0.3,
  ...
  "evolution": {
    "cluster_threshold": 3,
    "evolved_path": "~/.config/opencode/homunculus/evolved/"
  }
}
```
...
- Existing `~/.config/opencode/skills/learned/` skills still work
...
_Instinct-based learning: teaching Agent your patterns, one observation at a time._
